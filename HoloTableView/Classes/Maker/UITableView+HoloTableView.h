...
/**
 *  Creates a HoloTableViewUpdateRowMaker in the callee for current UITableView.
 *  Remake these rows (Reinit all properties) in the callee for the section according to the tag.
 *  If the section according to the tag don't contain these rows, ignore them.
 *
 *  @param block Scope within which you can create some rows which you wish to apply to the section according to the tag.
